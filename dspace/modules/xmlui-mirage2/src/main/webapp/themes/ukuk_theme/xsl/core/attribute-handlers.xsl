...
<xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1"
   ...
   <!--2.6.2017 <AM> přidán atribut pro dvojjazyčný text tlačítka ve filtrování výsledků -->
    <xsl:template name="renderGearButton">
        <button i18n:attr="title" title="xmlui.general.attr.dsSimpleSearch" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
