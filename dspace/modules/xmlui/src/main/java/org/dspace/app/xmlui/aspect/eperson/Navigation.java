...
public class Navigation extends AbstractDSpaceTransformer implements CacheableProcessingComponent
{
            ...
            UIException, SQLException, IOException, AuthorizeException
    {
        ...
        if (eperson != null)
        {
            ...
            // <JR> - 23. 6. 2017 - Remove logout button from e-person context menu of the sidebar
            //account.addItemXref(contextPath+"/logout",T_logout);
            account.addItemXref(contextPath+"/profile",T_profile.parameterize(fullName));
        } 
        else 
        {
        	// <JR> - 23. 6. 2017 - Removed login button from e-person context menu of the sidebar
