...
<xsl:stylesheet 
	...
	<xsl:template match="/">
		<oai_dc:dc xmlns:oai_dc="http://www.openarchives.org/OAI/2.0/oai_dc/" 
			...
			<!-- dc.contributor.* (!advisor and not opponent) -->
			<xsl:for-each select="doc:metadata/doc:element[@name='dc']/doc:element[@name='contributor']/doc:element[@name!='advisor' and @name!='opponent']/doc:element/doc:field[@name='value']">
			...
			<xsl:for-each select="doc:metadata/doc:element[@name='dc']/doc:element[@name='date']/doc:element[@name='issued']/doc:element/doc:field[@name='value']">
				<dc:issued><xsl:value-of select="." /></dc:issued>
			</xsl:for-each>
			<!-- dc.type -->
